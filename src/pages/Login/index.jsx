...
import { setToken, setUsername, getUsername, removeUsername, setRememberMe, 
getRememberMe, removeRememberMe, getToken} from '@/utils/localStorage';
  ...
  return (
   ...
   <Form
    ...
    <Form.Item
      ...
      <Checkbox checked={checked} onChange={(e) => setChecked(e.target.checked)}>{t('login_remember')}</Checkbox>
    </Form.Item>
